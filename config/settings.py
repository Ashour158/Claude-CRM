...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@company.com')
EMAIL_FROM_NAME = os.getenv('EMAIL_FROM_NAME', 'CRM System')
...
CRM_SETTINGS = {
    ...
    'TERRITORY_AUTO_ASSIGNMENT': True,
    'AUDIT_LOG_ENABLED': True,
    'BULK_OPERATIONS_LIMIT': 1000,
    'CSV_IMPORT_LIMIT': 10000,
