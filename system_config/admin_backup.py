...
from core.models import AuditLog  # Import from core instead
...
class AuditLogAdmin(admin.ModelAdmin):
    list_display = ['action', 'user', 'object_type', 'success', 'created_at']
    list_filter = ['action', 'success', 'created_at', 'company']
    search_fields = ['object_type', 'description', 'user__email']
    ordering = ['-created_at']
    raw_id_fields = ['user']
